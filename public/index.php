...
<?php include(SHARED_PATH . '/header.php');?>
    ...
    <div class="container">
      <img src="./img/dc1.png" id="topImage">
    ...
    <div class="container">
      <div class="row">
        <div class="col-6 workLink">
          ...
          <p id="descriptionMain">
            An test webpage built using bootstrap for the love of My Chemical Romance. Seriously, they were awesome. 
          </p>
        </div>
        <div class="col-6 workLink">
